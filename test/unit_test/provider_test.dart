...
import 'package:demo_movie_app/src/models/state.dart';
...
void main() {
  group("MovieApiProvider test", () {
    test("fetchMovieList success test", () async {
      ...
      when(mockClient.get(
          "http://api.themoviedb.org/3/movie/popular?api_key=1f9e7c30978e521fe36261c8c5b704e3"))
    ...
    test("fetchTrailer success test", () async {
      ...
      var mockClient = app.mockClient;
      when(mockClient.get(
          "http://api.themoviedb.org/3/movie/420818/videos?api_key=1f9e7c30978e521fe36261c8c5b704e3"))
          .thenAnswer((_) async => http.Response(
    ...
    test("fetchTrailer fail test", () async {
      ...
      var mockClient = app.mockClient;
      when(mockClient.get(
          "http://api.themoviedb.org/3/movie/428/videos?api_key=1f9e7c30978e521fe36261c8c5b704e3"))
          .thenAnswer((_) async => http.Response(
